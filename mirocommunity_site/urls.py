...
urlpatterns = patterns("",
    ...
    url(r'^signup/create(?:/(?P<tier_name>\w+))?/?$',
        SiteCreationView.as_view(template_name='mirocommunity_site/create_site.html'),
        name='mirocommunity_site_create'),
    url(r'^signup/?$',
        TemplateView.as_view(template_name='mirocommunity_site/signup.html'),
        {'NAME_TO_COST': NAME_TO_COST},
        'mirocommunity_site_signup'),

    url(r'^pubmedia/$',
        TemplateView.as_view(template_name='mirocommunity_site/pubmedia.html')),
    url(r'^features/$',
